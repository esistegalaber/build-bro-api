...
public class IDeploymentLabel implements Serializable, Comparable<IDeploymentLabel> {
    private Long id;
    private String key;
    ...
    @Override
    public int compareTo(IDeploymentLabel other) {
    ...
    public boolean equals(Object o) {
        ...
        IDeploymentLabel that = (IDeploymentLabel) o;
